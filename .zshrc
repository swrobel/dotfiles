...
alias rdbrc='rake db:drop db:setup'
alias rdbrm='rake db:drop db:create db:migrate db:seed'
alias rdbtp='RAILS_ENV=test rake db:drop db:schema:load_if_ruby db:structure:load_if_sql'
