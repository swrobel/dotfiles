...
heroku_console() {
  heroku run $@ -- "USER=swrobel rails console -- --simple-prompt"
}
...
alias gft='git fetch --prune --prune-tags --tags --force'
...
alias gl='gft && git pull --rebase --autostash'
alias gla='gl --all'
alias gs='git status -s'
alias gss='git status'
alias gcom='gco $(gdb) && gl && gbp'
